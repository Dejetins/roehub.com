...
class MarketDataPostgresGateway(Protocol):
    """
    Minimal SQL gateway for Market Data Postgres adapters.
    """
...
class PsycopgMarketDataPostgresGateway(MarketDataPostgresGateway):
    """
    psycopg3 implementation for Market Data Postgres adapters.
    """

    def __init__(self, *, dsn: str) -> None:
        normalized_dsn = dsn.strip()
        if not normalized_dsn:
            raise ValueError("PsycopgMarketDataPostgresGateway requires non-empty dsn")
