        ...
        repair_package = BacktestAiPromptPackage(
            ...
            user_message=BacktestAiPromptMessage(
                ...
                content=(
                    ...
                    "If the previous draft contains a complete config and all "
                    "validation errors are repaired, return status=\"config_ready\"; "
                    "do not ask for fields already present in PREVIOUS_JSON_DRAFT. "
