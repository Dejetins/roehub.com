"""
Numpy oracle implementation for volume-family indicators.
...
Related: docs/architecture/indicators/indicators_formula.yaml,
  trading.contexts.indicators.adapters.outbound.compute_numba.kernels.volume,
...
def is_nan(value: float) -> bool:
    """
    Return whether provided scalar is NaN.
    ...
    Assumptions:
        Scalar input is compatible with `math.isnan`.
    Raises:
        None.
    Side Effects:
        None.
