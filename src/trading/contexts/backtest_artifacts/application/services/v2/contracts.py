...
AVAILABILITY_SUMMARY_FILENAME_V2 = "availability_summary.yaml"
...
AVAILABILITY_SUMMARY_SCHEMA_VERSION_V2 = 1
AVAILABILITY_SUMMARY_SOURCE_LITERAL_V2 = "artifact_publisher_active_slot_scan"
ROOT_ARTIFACT_MANIFEST_SCHEMA_VERSION_V2 = 1
ARTIFACT_ROOT_SCHEMA_VERSION_V2 = 2
