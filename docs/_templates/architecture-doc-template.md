...
- Новые архитектурные документы пишем на русском языке; технические идентификаторы, пути, env-ключи, API routes и имена сущностей оставляем в оригинале.
- Охват и то, что не входит в документ, должны быть явно зафиксированы.
...
- [ ] Явно описаны `Цель`, `Охват`, `Что не входит`, инварианты и риски.
