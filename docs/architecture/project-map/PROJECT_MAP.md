...
Карта построена детерминированно из каталога и фактического набора файлов/импортов. Generated-артефакты самой карты исключены из самоссылочного inventory. Текущий структурный digest: `f49765780fc8034cf00504f9339a58289b1c70b3c3a0bbf36a48348ed30583e6`; учтено файлов: **3051**.
...
| `quality` | Проверки и тестовые данные | Unit, integration, notebook и performance-smoke проверки, fixtures и typings. | 430 | `tests/`, `fixtures/`, `typings/` |
| `knowledge` | Документация и агентные контракты | Архитектура, runbooks, планы, правила агентов и индекс проекта. | 1095 | `docs/`, `.codex/`, `AGENTS.md`, `README.md` |
