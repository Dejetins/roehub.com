...
- Compute/performance: `pass`; speed ratio May2/current = `0.927..0.959`.
- CPU: `pass`; mean child CPU = `1020.200..1165.982%`.
- Acceptance: `fail`; старые vmmap-contaminated результаты не учитываются.
- Что не прошло: memory failed jobs = `['tp_sl_grid/arity_6/long_only']`, lazy status path = `queued -> running -> completed`.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `tp_sl_grid/arity_6/long_only` | 12 | 18.184 | 17.446 | 0.959 | 1020.200 | 1180.800 | 1198.500 | fail |
| `tp_sl_grid/arity_6/long_short_reversal` | 12 | 17.474 | 16.204 | 0.927 | 1165.982 | 1169.300 | 1196.100 | pass |
...
| --- | ---: | --- | ---: | ---: | --- | ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `tp_sl_grid/arity_6/long_only` | 112.916 | runtime_pack | 28.390 | n/a | False | 1970496 | 3421 | True | True | 46656 | 46656 | 2565.769 | 5667783.974 | 36 | 36 | 46656 | 11.559 | n/a | `['sidecar_load_ms', 'sidecar_fallback_reason', 'sidecar_dir', 'rows_before_prefilter', 'avg_segments_per_candidate', 'avg_trades_per_candidate', 'tp_sl_selected_cell_shadow_status', 'tp_sl_selected_cell_parity_pass', 'tp_sl_selected_cell_scores', 'tp_sl_selected_cell_elapsed_ms', 'tp_sl_by_entry_selected_arrays_bytes']` |
| `tp_sl_grid/arity_6/long_short_reversal` | 78.562 | runtime_pack | 23.650 | n/a | False | 1970496 | 3421 | True | True | 46656 | 46656 | 2670.092 | 5898232.514 | 36 | 36 | 46656 | 10.375 | n/a | `['sidecar_load_ms', 'sidecar_fallback_reason', 'sidecar_dir', 'rows_before_prefilter', 'avg_segments_per_candidate', 'avg_trades_per_candidate', 'tp_sl_selected_cell_shadow_status', 'tp_sl_selected_cell_parity_pass', 'tp_sl_selected_cell_scores', 'tp_sl_selected_cell_elapsed_ms', 'tp_sl_by_entry_selected_arrays_bytes']` |
...
- Checked jobs: `2`
- Failed jobs: `['tp_sl_grid/arity_6/long_only']`
- System memory failed jobs: `['tp_sl_grid/arity_6/long_only']`
- System cleanup limit bytes: `536870912`
- vmmap / physical footprint: `no`

## Lazy cache-hit memory

- Target job: `1b02a105-3f0a-40bd-b3bd-805b3d282c68`
