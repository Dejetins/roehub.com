...
- Compute/performance: `fail`; speed ratio May2/current = `0.680..0.930`.
- CPU: `pass`; mean child CPU = `668.519..1154.808%`.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `tp_sl_grid/arity_6/long_only` | 12 | 25.645 | 17.446 | 0.680 | 668.519 | 1134.500 | 1192.700 | pass |
| `tp_sl_grid/arity_6/long_short_reversal` | 12 | 17.428 | 16.204 | 0.930 | 1154.808 | 1174.600 | 1183.900 | pass |
...
| --- | ---: | --- | ---: | ---: | --- | ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `tp_sl_grid/arity_6/long_only` | 80.399 | runtime_pack | 23.402 | n/a | False | 1970496 | 3421 | True | True | 46656 | 46656 | 1819.269 | 4018766.227 | 36 | 36 | 46656 | 10.570 | n/a | `['sidecar_load_ms', 'sidecar_fallback_reason', 'sidecar_dir', 'rows_before_prefilter', 'prefix_nodes_visited', 'prefix_nodes_reused', 'prefix_pruned_subtrees', 'prefix_pruned_candidate_upper_bound', 'prefix_candidates_selected', 'prefix_candidates_pruned', 'selectivity_order', 'combo_iteration_candidates_per_sec', 'prefix_total_elapsed_s', 'prefix_compiled_loop_elapsed_s', 'avg_segments_per_candidate', 'avg_trades_per_candidate', 'tp_sl_selected_cell_shadow_status', 'tp_sl_selected_cell_parity_pass', 'tp_sl_selected_cell_scores', 'tp_sl_selected_cell_elapsed_ms', 'tp_sl_by_entry_selected_arrays_bytes']` |
| `tp_sl_grid/arity_6/long_short_reversal` | 80.377 | runtime_pack | 24.562 | n/a | False | 1970496 | 3421 | True | True | 46656 | 46656 | 2677.044 | 5913589.898 | 36 | 36 | 46656 | 10.434 | n/a | `['sidecar_load_ms', 'sidecar_fallback_reason', 'sidecar_dir', 'rows_before_prefilter', 'prefix_nodes_visited', 'prefix_nodes_reused', 'prefix_pruned_subtrees', 'prefix_pruned_candidate_upper_bound', 'prefix_candidates_selected', 'prefix_candidates_pruned', 'selectivity_order', 'combo_iteration_candidates_per_sec', 'prefix_total_elapsed_s', 'prefix_compiled_loop_elapsed_s', 'avg_segments_per_candidate', 'avg_trades_per_candidate', 'tp_sl_selected_cell_shadow_status', 'tp_sl_selected_cell_parity_pass', 'tp_sl_selected_cell_scores', 'tp_sl_selected_cell_elapsed_ms', 'tp_sl_by_entry_selected_arrays_bytes']` |
...
- Target job: `9d383d2c-2a46-428a-b2f8-cd1ced59a741`
