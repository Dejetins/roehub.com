...
- Compute/performance: `pass`; speed ratio May2/current = `0.920..0.930`.
- CPU: `pass`; mean child CPU = `1063.681..1149.025%`.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `tp_sl_grid/arity_6/long_only` | 12 | 18.956 | 17.446 | 0.920 | 1063.681 | 1144.900 | 1190.200 | pass |
| `tp_sl_grid/arity_6/long_short_reversal` | 12 | 17.426 | 16.204 | 0.930 | 1149.025 | 1178.100 | 1193.100 | pass |
...
| --- | ---: | --- | ---: | ---: | --- | ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `tp_sl_grid/arity_6/long_only` | 80.485 | runtime_pack | 23.953 | n/a | False | 1970496 | 3421 | True | True | 46656 | 46656 | 2461.287 | 5436982.950 | 36 | 36 | 46656 | 10.603 | n/a | `['sidecar_load_ms', 'sidecar_fallback_reason', 'sidecar_dir', 'rows_before_prefilter', 'prefix_nodes_visited', 'prefix_nodes_reused', 'prefix_pruned_subtrees', 'prefix_pruned_candidate_upper_bound', 'prefix_candidates_selected', 'prefix_candidates_pruned', 'selectivity_order', 'combo_iteration_candidates_per_sec', 'prefix_total_elapsed_s', 'prefix_compiled_loop_elapsed_s', 'avg_segments_per_candidate', 'avg_trades_per_candidate', 'tp_sl_selected_cell_shadow_status', 'tp_sl_selected_cell_parity_pass', 'tp_sl_selected_cell_scores', 'tp_sl_selected_cell_elapsed_ms', 'tp_sl_by_entry_selected_arrays_bytes']` |
| `tp_sl_grid/arity_6/long_short_reversal` | 78.575 | runtime_pack | 24.598 | n/a | False | 1970496 | 3421 | True | True | 46656 | 46656 | 2677.422 | 5914425.428 | 36 | 36 | 46656 | 10.382 | n/a | `['sidecar_load_ms', 'sidecar_fallback_reason', 'sidecar_dir', 'rows_before_prefilter', 'prefix_nodes_visited', 'prefix_nodes_reused', 'prefix_pruned_subtrees', 'prefix_pruned_candidate_upper_bound', 'prefix_candidates_selected', 'prefix_candidates_pruned', 'selectivity_order', 'combo_iteration_candidates_per_sec', 'prefix_total_elapsed_s', 'prefix_compiled_loop_elapsed_s', 'avg_segments_per_candidate', 'avg_trades_per_candidate', 'tp_sl_selected_cell_shadow_status', 'tp_sl_selected_cell_parity_pass', 'tp_sl_selected_cell_scores', 'tp_sl_selected_cell_elapsed_ms', 'tp_sl_by_entry_selected_arrays_bytes']` |

## TP/SL cell backend

| Job | backend | block | blocks/candidate | block bytes | trade-cell evals |
| --- | --- | --- | ---: | ---: | ---: |
| `tp_sl_grid/arity_6/long_only` | matrix_cell_tp_sl_v1 | 128 x 32 | 2 | 100872 | 103063104 |
| `tp_sl_grid/arity_6/long_short_reversal` | matrix_cell_tp_sl_v1 | 128 x 32 | 2 | 100872 | 103063104 |
...
- Target job: `0ecab62b-289c-42bd-b30a-810f6fe0a5ca`
