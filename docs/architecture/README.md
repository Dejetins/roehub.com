...
- [Backtest Service Artifact Runtime v1](docs/architecture/backtest/backtest-service-artifact-runtime-v1.md) — `docs/architecture/backtest/backtest-service-artifact-runtime-v1.md` — Документ фиксирует целевую архитектуру artifact-backed backtest service, его публичный API, job flow, lazy trades detail и benchmark-gate по итерациям.
