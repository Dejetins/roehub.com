...
- [Milestone 4 — Backtest v1 (close-fill, single instrument; multi-variant grid) — plan draft](docs/architecture/roadmap/milestone-4-backtest-v1-plan-draft.md) — `docs/architecture/roadmap/milestone-4-backtest-v1-plan-draft.md` — Этот файл оставлен как “снимок” полного текста Milestone 4 из `docs/architecture/roadmap/base_milestone_plan.md`, чтобы удобно обсуждать изменения до подготовки EPIC map.
