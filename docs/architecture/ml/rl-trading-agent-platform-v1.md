...
20. Stage `09` is now the active registry/activation gate. It must validate artifact hashes, registry state-machine invariants, lifecycle controls and activation boundaries before any downstream runtime use.
