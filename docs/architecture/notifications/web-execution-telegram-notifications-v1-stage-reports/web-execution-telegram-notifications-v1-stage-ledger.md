...
| `02` Source router synthetic event coverage | pending | `02-source-router-synthetic-event-coverage.md` | unit/integration synthetic matrix | Map strategy/live_execution/admin/report source facts into generic notification events and delivery decisions using `log_only`. | nothing | none | yes |
