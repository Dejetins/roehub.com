---
prompt_name: mainnet-real-money-trading-v1-10-ops-canary-binance-spot-long
repo: /Users/daniildegtyarev/Projects/roehub.com
branch: main
scope: "Real mainnet ops canary: Binance spot long"
language:
...
required_literals:
  - "User required before start: explicit bounded canary window approval"
  - "previous stage"
  - "file manifest"
non_goals:
...
change_ownership:
  ...
  owned_change_scope: ["Stage 10 scoped files/hunks only", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/10-ops-canary-binance-spot-long.md", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/mainnet-real-money-trading-v1-stage-ledger.md"]
...
validation_strategy:
  ...
  evidence_target: docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/10-ops-canary-binance-spot-long.md
proof_boundary:
...
file_manifest:
  ...
  expected_groups:
    ...
    docs_runbooks: ["docs/runbooks/**", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/10-ops-canary-binance-spot-long.md", "docs/architecture/README.md"]
...
expected_primary_touches: ["docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/10-ops-canary-binance-spot-long.md", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/mainnet-real-money-trading-v1-stage-ledger.md"]
...
safety_notes:
  - "first real mainnet order; stop on unknown or close failure"
  - "No blind retry after unknown provider state."
---

# Task

Real mainnet ops canary: Binance spot long.
...
- Record `User required before start: explicit bounded canary window approval` in the stage report and ledger.
- Run only this canary row, sequentially.
- Submit Binance spot buy market <=15 USDT only with accepted canary scope.
...
- Update `docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/10-ops-canary-binance-spot-long.md` with evidence, blockers, file manifest, contract impact and next-stage handoff.
...
- Stage `10` is not accepted unless: Binance spot buy market <=15 USDT opens, close sell by filled base qty, alert/reconciliation/latency/slippage pass, no residual exposure.
...
- Primary: `docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/10-ops-canary-binance-spot-long.md`, `docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/mainnet-real-money-trading-v1-stage-ledger.md`.
