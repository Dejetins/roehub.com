---
prompt_name: mainnet-real-money-trading-v1-13-ops-canary-binance-futures-short
repo: /Users/daniildegtyarev/Projects/roehub.com
branch: main
scope: "Real mainnet ops canary: Binance futures short"
language:
...
required_literals:
  - "User required before start: Stage 12 accepted"
  - "previous stage"
  - "file manifest"
non_goals:
...
change_ownership:
  ...
  owned_change_scope: ["Stage 13 scoped files/hunks only", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/13-ops-canary-binance-futures-short.md", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/mainnet-real-money-trading-v1-stage-ledger.md"]
...
validation_strategy:
  ...
  e2e_required: true
  acceptance_surfaces: ["real futures order/fill/close/reconcile/alert", "stage report", "stage ledger"]
  tests_only_allowed_reason: null
  evidence_target: docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/13-ops-canary-binance-futures-short.md
proof_boundary:
...
file_manifest:
  ...
  expected_groups:
    ...
    docs_runbooks: ["docs/runbooks/**", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/13-ops-canary-binance-futures-short.md", "docs/architecture/README.md"]
...
expected_primary_touches: ["docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/13-ops-canary-binance-futures-short.md", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/mainnet-real-money-trading-v1-stage-ledger.md"]
...
safety_notes:
  - "real futures short exposure; reduce-only close must work"
  - "No blind retry after unknown provider state."
---

# Task

Real mainnet ops canary: Binance futures short.
...
- previous-stage ledger gate / previous stage: before any implementation or runtime action, read `stage_ledger` and confirm Stage `12` is `accepted`. If not, update Stage `13` as `blocked`, write the blocker in `stage_ledger`, and stop.
...
- Record `User required before start: Stage 12 accepted` in the stage report and ledger.
- Run only this futures short canary row.
- Verify fresh futures config snapshot before submit.
- Open Binance futures short market <=15 USDT and close reduce-only immediately.
- Prove fill and position reconciliation matched; funding_not_due_yet must not block closure.
- Verify alert, latency/slippage, Redis/DB clean state and zero residual position.
- Update `docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/13-ops-canary-binance-futures-short.md` with evidence, blockers, file manifest, contract impact and next-stage handoff.
...
- Stage `13` is not accepted unless: Binance futures short open/close reduce-only market <=15 USDT, isolated 1x, fill/position reconciliation matched, funding not blocking.
...
- Primary: `docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/13-ops-canary-binance-futures-short.md`, `docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/mainnet-real-money-trading-v1-stage-ledger.md`.
