---
prompt_name: mainnet-real-money-trading-v1-14-ops-canary-bybit-futures-long
repo: /Users/daniildegtyarev/Projects/roehub.com
branch: main
scope: "Real mainnet ops canary: Bybit futures long"
language:
...
required_literals:
  - "User required before start: Stage 13 accepted"
  - "previous stage"
  - "file manifest"
non_goals:
...
change_ownership:
  ...
  owned_change_scope: ["Stage 14 scoped files/hunks only", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/14-ops-canary-bybit-futures-long.md", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/mainnet-real-money-trading-v1-stage-ledger.md"]
...
validation_strategy:
  ...
  evidence_target: docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/14-ops-canary-bybit-futures-long.md
proof_boundary:
...
file_manifest:
  ...
  expected_groups:
    ...
    docs_runbooks: ["docs/runbooks/**", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/14-ops-canary-bybit-futures-long.md", "docs/architecture/README.md"]
...
expected_primary_touches: ["docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/14-ops-canary-bybit-futures-long.md", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/mainnet-real-money-trading-v1-stage-ledger.md"]
...
Real mainnet ops canary: Bybit futures long.
...
- previous-stage ledger gate / previous stage: before any implementation or runtime action, read `stage_ledger` and confirm Stage `13` is `accepted`. If not, update Stage `14` as `blocked`, write the blocker in `stage_ledger`, and stop.
...
- Record `User required before start: Stage 13 accepted` in the stage report and ledger.
- Run only this futures long canary row.
- Verify fresh futures config snapshot before submit.
- Open Bybit futures long market <=15 USDT and close reduce-only immediately.
...
- Update `docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/14-ops-canary-bybit-futures-long.md` with evidence, blockers, file manifest, contract impact and next-stage handoff.
...
- Stage `14` is not accepted unless: Bybit futures long open/close reduce-only market <=15 USDT, isolated 1x, fill/position reconciliation matched, funding not blocking.
...
- Primary: `docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/14-ops-canary-bybit-futures-long.md`, `docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/mainnet-real-money-trading-v1-stage-ledger.md`.
