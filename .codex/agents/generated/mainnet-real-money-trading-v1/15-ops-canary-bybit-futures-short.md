---
prompt_name: mainnet-real-money-trading-v1-15-ops-canary-bybit-futures-short
repo: /Users/daniildegtyarev/Projects/roehub.com
branch: main
scope: "Real mainnet ops canary: Bybit futures short"
language:
...
required_literals:
  - "User required before start: Stage 14 accepted"
  - "previous stage"
  - "file manifest"
non_goals:
...
change_ownership:
  ...
  owned_change_scope: ["Stage 15 scoped files/hunks only", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/15-ops-canary-bybit-futures-short.md", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/mainnet-real-money-trading-v1-stage-ledger.md"]
...
validation_strategy:
  ...
  evidence_target: docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/15-ops-canary-bybit-futures-short.md
proof_boundary:
...
file_manifest:
  ...
  expected_groups:
    ...
    docs_runbooks: ["docs/runbooks/**", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/15-ops-canary-bybit-futures-short.md", "docs/architecture/README.md"]
...
expected_primary_touches: ["docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/15-ops-canary-bybit-futures-short.md", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/mainnet-real-money-trading-v1-stage-ledger.md"]
...
Real mainnet ops canary: Bybit futures short.
...
- previous-stage ledger gate / previous stage: before any implementation or runtime action, read `stage_ledger` and confirm Stage `14` is `accepted`. If not, update Stage `15` as `blocked`, write the blocker in `stage_ledger`, and stop.
...
- Record `User required before start: Stage 14 accepted` in the stage report and ledger.
- Run only this futures short canary row.
- Verify fresh futures config snapshot before submit.
- Open Bybit futures short market <=15 USDT and close reduce-only immediately.
...
- Update `docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/15-ops-canary-bybit-futures-short.md` with evidence, blockers, file manifest, contract impact and next-stage handoff.
...
- Stage `15` is not accepted unless: Bybit futures short open/close reduce-only market <=15 USDT, isolated 1x, fill/position reconciliation matched, funding not blocking.
...
- Primary: `docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/15-ops-canary-bybit-futures-short.md`, `docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/mainnet-real-money-trading-v1-stage-ledger.md`.
