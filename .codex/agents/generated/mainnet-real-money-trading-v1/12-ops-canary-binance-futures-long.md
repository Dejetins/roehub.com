---
prompt_name: mainnet-real-money-trading-v1-12-ops-canary-binance-futures-long
repo: /Users/daniildegtyarev/Projects/roehub.com
branch: main
scope: "Real mainnet ops canary: Binance futures long"
language:
...
required_literals:
  - "User required before start: Stage 11 accepted"
  - "previous stage"
  - "file manifest"
non_goals:
...
change_ownership:
  ...
  owned_change_scope: ["Stage 12 scoped files/hunks only", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/12-ops-canary-binance-futures-long.md", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/mainnet-real-money-trading-v1-stage-ledger.md"]
...
validation_strategy:
  ...
  evidence_target: docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/12-ops-canary-binance-futures-long.md
proof_boundary:
...
file_manifest:
  ...
  expected_groups:
    ...
    docs_runbooks: ["docs/runbooks/**", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/12-ops-canary-binance-futures-long.md", "docs/architecture/README.md"]
...
expected_primary_touches: ["docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/12-ops-canary-binance-futures-long.md", "docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/mainnet-real-money-trading-v1-stage-ledger.md"]
...
safety_notes:
  - "real futures exposure; reduce-only close must work"
  - "No blind retry after unknown provider state."
---

# Task

Real mainnet ops canary: Binance futures long.
...
- previous-stage ledger gate / previous stage: before any implementation or runtime action, read `stage_ledger` and confirm Stage `11` is `accepted`. If not, update Stage `12` as `blocked`, write the blocker in `stage_ledger`, and stop.
...
- Record `User required before start: Stage 11 accepted` in the stage report and ledger.
- Run only this futures long canary row.
- Verify fresh futures config snapshot before submit.
- Open Binance futures long market <=15 USDT and close reduce-only immediately.
...
- Update `docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/12-ops-canary-binance-futures-long.md` with evidence, blockers, file manifest, contract impact and next-stage handoff.
...
- Stage `12` is not accepted unless: Binance futures long open/close reduce-only market <=15 USDT, isolated 1x, fill/position reconciliation matched, funding not blocking.
...
- Primary: `docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/12-ops-canary-binance-futures-long.md`, `docs/architecture/live_execution/mainnet-real-money-trading-v1-stage-reports/mainnet-real-money-trading-v1-stage-ledger.md`.
