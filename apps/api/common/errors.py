...
_ROEHUB_STATUS_BY_CODE: Mapping[str, int] = {
    ...
    "backtest.ai_config.forbidden": 403,
    "backtest.ai_config.idempotency_key_conflict": 409,
    "backtest.ai_config.invalid_request": 422,
    "backtest.ai_config.not_found": 404,
    "backtest.ai_config.unavailable": 503,
