...
`oss_policy.json` — проверяемый реестр прямых Python-зависимостей,
контейнерных образов, встроенных ресурсов и первых графических ресурсов.
Статусы имеют следующий смысл:
